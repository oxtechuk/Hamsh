...
const fieldCls = [
  ...
  "transition focus:border-[#C5232B] focus:ring-2 focus:ring-[#C5232B]/10",
].join(" ");
    ...
    <div className="rounded-[16px] border border-[#E7E7E7] bg-white px-6 py-7 shadow-sm">
      ...
      <div className="mt-4 flex items-center gap-3 rounded-[10px] bg-[#EFEFEF] px-4 py-3">
        ...
        <div className="min-w-0 flex-1 text-start">
          ...
          <p className="text-[12px] font-bold text-[#C5232B]">
            {fmt(carPrice)} {riyal}
          </p>
        </div>
      </div>
      ...
      <div className="mt-5">
        <div className="mb-2 flex items-center justify-between text-[13px]">
          ...
          <strong className="text-[#C5232B] font-extrabold">
          ...
          {TERM_OPTIONS.map((opt) => (
            <button
              ...
              className={[
                ...
                term === opt
                  ? "border-[#C5232B] bg-[#C5232B] text-white"
                  : "border-[#E7E7E7] bg-white text-[#8A8A8A] hover:border-[#C5232B] hover:text-[#C5232B]",
              ].join(" ")}
            >
              {opt}
            </button>
