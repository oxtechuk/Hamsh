...
mix.webpackConfig({
    output: {
        chunkFilename: 'assets/js/erp/[name].js?id=[chunkhash]'
    },
    performance: {
    ...
    resolve: {
        ...
        alias: {
            ...
            '@': path.resolve(__dirname, 'resources/js/erp')
        }
    },
    plugins: [
        new VueLoaderPlugin(),
...
// Compile Vue ERP Entrypoint
mix.js('resources/js/erp/app.js', 'assets/js/erp.js').vue({ version: 3 });
