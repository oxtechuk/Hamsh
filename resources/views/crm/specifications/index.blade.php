                    ...
                    <tbody>
                        @forelse ($specifications as $spec)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-muted">{{ $spec->value ? ($spec->getTranslation('value', 'ar') ?? '') . ' / ' . ($spec->getTranslation('value', 'en') ?? '') : '—' }}</td>
                                            ...
                                            <div class="modal-body text-start">
                                                ...
                                                <div class="tab-content mb-3">
                                                    <div class="tab-pane fade show active" id="edit-ar-spec-{{ $spec->id }}">
                                                        ...
                                                        <label class="form-label fw-semibold mt-3">{{ __('قيمة المواصفة (بالعربية)') }}</label>
                                                        <input type="text" name="value[ar]" class="form-control rounded-3"
                                                            value="{{ $spec->getTranslation('value', 'ar', false) ?? '' }}">
                                                    </div>
                                                    <div class="tab-pane fade" id="edit-en-spec-{{ $spec->id }}">
                                                        ...
                                                        <label class="form-label fw-semibold mt-3">{{ __('قيمة المواصفة (بالإنجليزية)') }}</label>
                                                        <input type="text" name="value[en]" class="form-control rounded-3"
                                                            value="{{ $spec->getTranslation('value', 'en', false) ?? '' }}">
                                                    </div>
                                                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="tab-content mb-3">
                                <div class="tab-pane fade show active" id="add-ar-spec">
                                    ...
                                    <label class="form-label fw-semibold mt-3">{{ __('قيمة المواصفة (بالعربية)') }}</label>
                                    <input type="text" name="value[ar]" class="form-control rounded-3" placeholder="{{ __('مثال: مفتوح') }}">
                                </div>
                                <div class="tab-pane fade" id="add-en-spec">
                                    ...
                                    <label class="form-label fw-semibold mt-3">{{ __('قيمة المواصفة (بالإنجليزية)') }}</label>
                                    <input type="text" name="value[en]" class="form-control rounded-3" placeholder="{{ __('e.g., Opened') }}">
                                </div>
                            </div>
