...
@section('title', __('العملاء') . ' | hamsh ')
...
@section('content')
    <div class="container-fluid" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
                            ...
                            <tr>
                                <td class="px-4">
                                    <input type="checkbox" name="lead_ids[]" value="{{ $lead->id }}"
                                        class="form-check-input lead-checkbox" {{ $lead->client_phone ? '' : 'disabled' }}>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex gap-2 align-items-center">
                                        ...
                                        @can('manage-leads')
                                            <a href="{{ route('crm.leads.edit', $lead) }}" class="btn btn-sm btn-light rounded-2"
                                                title="{{ __('تعديل') }}">
        ...
        <div class="modal fade" id="whatsappCampaignModal" tabindex="-1"
