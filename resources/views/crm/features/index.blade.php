                    ...
                    <tbody>
                        @forelse ($features as $feature)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-muted">{{ $feature->value ? ($feature->value['ar'] ?? '') . ' / ' . ($feature->value['en'] ?? '') : '—' }}</td>
                                            ...
                                            <div class="modal-body text-start">
                                                ...
                                                <div class="tab-content mb-3">
                                                    <div class="tab-pane fade show active" id="edit-ar-feat-{{ $feature->id }}">
                                                        ...
                                                        <label class="form-label fw-semibold mt-3">{{ __('قيمة الخاصية (بالعربية)') }}</label>
                                                        <input type="text" name="value[ar]" class="form-control rounded-3"
                                                            value="{{ $feature->getTranslation('value', 'ar', false) ?? '' }}">
                                                    </div>
                                                    <div class="tab-pane fade" id="edit-en-feat-{{ $feature->id }}">
                                                        ...
                                                        <label class="form-label fw-semibold mt-3">{{ __('قيمة الخاصية (بالإنجليزية)') }}</label>
                                                        <input type="text" name="value[en]" class="form-control rounded-3"
                                                            value="{{ $feature->getTranslation('value', 'en', false) ?? '' }}">
                                                    </div>
                                                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="tab-content mb-3">
                                <div class="tab-pane fade show active" id="add-ar-feat">
                                    ...
                                    <label class="form-label fw-semibold mt-3">{{ __('قيمة الخاصية (بالعربية)') }}</label>
                                    <input type="text" name="value[ar]" class="form-control rounded-3" placeholder="{{ __('مثال: متاحة') }}">
                                </div>
                                <div class="tab-pane fade" id="add-en-feat">
                                    ...
                                    <label class="form-label fw-semibold mt-3">{{ __('قيمة الخاصية (بالإنجليزية)') }}</label>
                                    <input type="text" name="value[en]" class="form-control rounded-3" placeholder="{{ __('e.g., Available') }}">
                                </div>
                            </div>
