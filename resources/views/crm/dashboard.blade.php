            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden"
                ...
                <div class="card-body px-4 py-3">
                    <div class="d-flex align-items-center flex-wrap gap-4">
                        ...
                        <a href="{{ route('crm.settings.seo') }}" class="btn btn-sm rounded-3 ms-auto"
                            style="background:var(--crm-red-light);color:var(--crm-red);font-weight:700;font-size:11px;text-decoration:none;">
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100" style="border:1px solid var(--crm-border)!important;">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                <thead style="background:#F8F9FC;">
                                    <tr>
                                        <th class="px-4 py-3 text-muted fw-bold" style="font-size:12px;">
                                            {{ __('رقم الطلب') }}</th>
                                ...
                                <tbody>
                                    @forelse($recentBookings as $booking)
                                        <tr>
                                            <td class="px-4 fw-bold" style="font-size:13px;">
                                                <a href="{{ route('crm.bookings.show', $booking) }}"
                                                    class="text-decoration-none"
                                                    style="color:var(--crm-text);">#{{ $booking->id }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div style="font-size:12px;color:var(--crm-text);">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-5">{{ __('لا توجد طلبات') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                        ...
                        <div class="px-4 py-3" style="border-top:1px solid var(--crm-border);">
                            <a href="{{ route('crm.bookings.index') }}" class="text-decoration-none fw-bold"
                                style="font-size:13px;color:var(--crm-red);">{{ __('عرض كل الطلبات') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card border-0 shadow-sm rounded-4"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="fw-black mb-1" style="font-size:24px;color:var(--crm-text);">
                                    ...
                                    <small
                                        style="font-size:13px;font-weight:600;color:var(--crm-text-muted);">{{ __('ريال سعودي') }}</small>
                                </div>
                        ...
                        <div class="card border-0 shadow-sm rounded-4"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="fw-black mb-1" style="font-size:24px;color:var(--crm-text);">
                                    {{ $stats['rejected'] ?? 0 }}
                                    <small
                                        style="font-size:13px;font-weight:600;color:var(--crm-text-muted);">{{ __('شكوى') }}</small>
                                </div>
            ...
            <div class="col-12 col-xl-7">
                <div class="card border-0 shadow-sm rounded-4" style="border:1px solid var(--crm-border)!important;">
                    <div class="card-header bg-white border-0 pt-4 px-4 pb-2 d-flex justify-content-between align-items-center"
                        ...
                        <div class="d-flex gap-2">
                            <button class="btn btn-sm btn-light rounded-2 fw-bold"
                                style="font-size:12px;">{{ __('يوم') }}</button>
                            <button class="btn btn-sm btn-light rounded-2 fw-bold"
                                style="font-size:12px;">{{ __('أسبوع') }}</button>
                            <button class="btn btn-sm rounded-2 fw-bold"
                                style="font-size:12px;background:var(--crm-border);">{{ __('شهر') }}</button>
                            <button class="btn btn-sm btn-light rounded-2" style="font-size:12px;"><i
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100" style="border:1px solid var(--crm-border)!important;">
                    <div class="card-header bg-white border-0 pt-4 px-4 pb-2 d-flex justify-content-between align-items-center"
                        ...
                        <label class="d-flex align-items-center gap-2"
                            style="font-size:12px;color:var(--crm-text-muted);cursor:pointer;">
                    ...
                    <div class="card-body p-3" style="overflow-y:auto;max-height:340px;">
                        ...
                        @foreach($recentBookings->take(2) as $notif)
                            <div class="p-3 rounded-3 mb-3" style="background:#FFF8EC;border:1px solid #FDEBC8;">
                                <div class="d-flex align-items-start gap-3">
                                    <div
                                        style="width:36px;height:36px;background:#FFF0F0;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            ...
                                            <span style="font-size:11px;color:var(--crm-orange);">● {{ __('منذ') }} 5
                                                {{ __('دقائق') }}</span>
                                        </div>
                                        <p class="mb-2" style="font-size:12px;color:var(--crm-text-muted);">{{ __('طلب') }}
                                            #{{ $notif->id }} — {{ $notif->client_name }}</p>
                                        <div class="d-flex gap-2">
                                            <button class="btn btn-sm btn-light rounded-2 fw-bold"
                                                style="font-size:12px;">{{ __('تجاهل') }}</button>
                                            <a href="{{ route('crm.bookings.show', $notif) }}"
                                                class="btn btn-sm rounded-2 fw-bold text-white"
                                                style="font-size:12px;background:var(--crm-red);">{{ __('عرض التفاصيل') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if($recentBookings->count() > 2)
                            ...
                            <div class="p-3 rounded-3 mb-2" style="background:#FFF0F0;border:1px solid #FFCDD2;">
                                <div class="d-flex align-items-start gap-3">
                                    <div
                                        style="width:36px;height:36px;background:#FFEBEE;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                        <i class="bi bi-list-task" style="color:var(--crm-red);font-size:15px;"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <strong style="font-size:13px;">{{ __('مهمة متأخرة') }}</strong>
                                            <span style="font-size:11px;color:var(--crm-red);">● {{ __('منذ') }} 5
                                                {{ __('دقائق') }}</span>
                                        </div>
                                        <p class="mb-2" style="font-size:12px;color:var(--crm-text-muted);">
                                            {{ __('مهمة إرسال عرض الأسعار لم يتم تنفيذها') }}</p>
                                        <div class="d-flex gap-2">
                                            <button class="btn btn-sm btn-light rounded-2 fw-bold"
                                                style="font-size:12px;">{{ __('تجاهل') }}</button>
                                            <a href="{{ route('crm.tasks.index') }}"
                                                class="btn btn-sm rounded-2 fw-bold text-white"
                                                style="font-size:12px;background:var(--crm-red);">{{ __('فتح المهمة') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer bg-white border-0 text-center py-3"
                        style="border-top:1px solid var(--crm-border)!important;">
                        <a href="#" class="fw-bold text-decoration-none"
                            style="font-size:13px;color:var(--crm-text-muted);">{{ __('عرض الكل') }}</a>
                    </div>
                </div>
            </div>
        </div>
