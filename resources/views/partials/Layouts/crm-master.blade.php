    ...
    <style>
        ...
        * {
        ...
        .crm-sidebar {
            ...
            box-shadow:
                {{ App::getLocale() == 'ar' ? '-2px' : '2px' }}
                0 12px rgba(0, 0, 0, 0.04);
        }
        ...
        a.crm-nav-link.active::after {
            ...
            border-radius:
                {{ App::getLocale() == 'ar' ? '4px 0 0 4px' : '0 4px 4px 0' }}
            ;
        }
        ...
        .crm-topbar-search input::placeholder {
            color: #bbb;
        }
        ...
        .crm-stat-card.danger .crm-stat-value {
            color: var(--crm-red);
        }

        .crm-stat-card.info .crm-stat-value {
            color: #1877F2;
        }
        ...
        .crm-stat-new .stat-badge.orange {
            background: #FFF3E0;
            color: #E65100;
        }

        .crm-stat-new .stat-badge.green {
            background: #E8F5E9;
            color: #2E7D32;
        }

        .crm-stat-new .stat-badge.blue {
            background: #E3F2FD;
            color: #1565C0;
        }
        ...
        .crm-stat-new .stat-icon.red {
            background: #FFF0F0;
            color: var(--crm-red);
        }

        .crm-stat-new .stat-icon.green {
            background: #EDFAF4;
            color: #12B76A;
        }

        .crm-stat-new .stat-icon.blue {
            background: #EFF8FF;
            color: #2E90FA;
        }

        .crm-stat-new .stat-icon.orange {
            background: #FFF8EC;
            color: #F79009;
        }

        .crm-stat-new .stat-icon.purple {
            background: #F5F0FF;
            color: #7C3AED;
        }

        .crm-stat-new .stat-lbl {
            font-size: 12px;
            color: var(--crm-text-muted);
            font-weight: 600;
            margin-bottom: 4px;
        ...
        .btn-primary:hover {
            ...
            border-color: var(--crm-red-dark) !important;
        }
        ...
        @media (max-width: 768px) {
            ...
            .crm-sidebar.mob-open {
                ...
                box-shadow:
                    {{ App::getLocale() == 'ar' ? '-6px' : '6px' }}
                    0 30px rgba(0, 0, 0, 0.18);
            }
...
<body class="crm-shell">
    ...
    <script src="{{ asset('assets/libs/bootstrap/js/bootstrap.bundle.min.js') }}"
        onerror="document.write('<script src=\'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js\'><\/script>')"></script>
