...
<head>
    ...
    <title>{{ __('انتهت الجلسة') }} — hamsh </title>
    ...
    <style>
        * {
        ...
        .clock-icon {
            animation: clockSpin 4s ease-in-out infinite;
        }
...
<body>
    ...
    <div class="err-wrap">
        <div class="icon-wrap">
            <i class="bi bi-hourglass-split clock-icon"></i>
        </div>
        <div class="error-code">419</div>
        <div class="err-divider"></div>
        <h1 class="error-title">{{ __('انتهت') }} <span>{{ __('الجلسة') }}</span></h1>
        <p class="error-subtitle">{{ __('انتهت صلاحية جلستك بسبب عدم النشاط. يرجى تسجيل الدخول مرة أخرى للمتابعة.') }}
        </p>
        <div class="err-btn-group">
            <a href="/login" class="btn-err btn-err--primary">
