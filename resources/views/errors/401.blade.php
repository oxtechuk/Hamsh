...
<head>
    ...
    <title>{{ __('غير مصرح بالدخول') }} — GR Motors</title>
...
<body>
    ...
    <div class="err-wrap">
        ...
        <h1 class="error-title">{{ __('عذراً! أنت') }} <span>{{ __('غير مصرح') }}</span></h1>
        <p class="error-subtitle">{{ __('يجب عليك تسجيل الدخول أولاً للوصول إلى هذه الصفحة.') }}</p>
