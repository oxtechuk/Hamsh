...
@section('title', __('الصفحة غير موجودة') . ' — hamsh ')

@section('css')
    <style>
        /* ============================================================
           404 PAGE — hamsh  BRAND
        ============================================================ */
        ...
        <div class="err404-inner">
            ...
            <div class="car-wrap">
                <svg class="car-svg" viewBox="0 0 560 220" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M170 68 L200 40 L260 30 L320 30 L380 40 L410 68 Z" fill="#222" stroke="#444"
                        stroke-width="1" />
                    <path d="M185 67 L210 45 L260 35 L300 35 L340 45 L355 67 Z" fill="rgba(100,180,255,0.15)"
                        stroke="rgba(100,180,255,0.3)" stroke-width="1" />
                    <path d="M155 67 L185 67 L185 95 L145 95 Z" fill="rgba(100,180,255,0.12)"
                        stroke="rgba(100,180,255,0.25)" stroke-width="1" />
                    <path d="M355 67 L400 67 L415 95 L355 95 Z" fill="rgba(100,180,255,0.12)"
                        stroke="rgba(100,180,255,0.25)" stroke-width="1" />
                    ...
                    <text x="280" y="118" text-anchor="middle" font-family="Cairo,sans-serif" font-size="13"
                        font-weight="900" fill="white">GR</text>
            ...
            <div class="err-btn-group">
                <a href="/" class="btn-404 btn-404--primary">
                    <i class="bi bi-house-door-fill"></i>
                    {{ __('الصفحة الرئيسية') }}
                </a>
                <a href="/cars" class="btn-404 btn-404--ghost">
            ...
            <div class="quick-links">
                <a href="/offers" class="quick-link">
