...
import type { IFeaturedBlogsSectionProps } from "../../interfaces/IFeaturedBlogsSectionProps";
            ...
            <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-[2fr_1fr] lg:gap-10">
                    ...
                    <NavLink
                        ...
                        className="group relative order-1 min-h-[520px] overflow-hidden bg-[#20283A] lg:order-1"
                    >
                        <LazyImg
                            src={featured.image}
                            alt={featured.title}
                    ...
                    {/* Related list */}
                    <aside className="order-2 border border-[#E5DED1] bg-transparent lg:order-2">
