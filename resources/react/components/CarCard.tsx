...
export default function CarCard({
    ...
    return (
        <article
            ...
            className={[
                "group relative flex w-full flex-col overflow-hidden rounded-[16px]",
            ...
            <div className="relative h-[210px] sm:h-[230px] w-full shrink-0 overflow-hidden bg-[#F4F4F4]">
                ...
                {finalBadge && (
                    <div className="absolute start-3 top-3 z-10">
                        <span
                            className="inline-flex items-center justify-center rounded-[4px] px-3 py-1 text-[12px] font-bold text-white shadow-xs"
                            style={{
                                backgroundColor: finalBadge.color || "#DFA655",
                            }}
                        >
                            {finalBadge.text}
                        </span>
