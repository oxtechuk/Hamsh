...
export default function DriveStepTwo({
  ...
  if (isLoading) {
    return (
      <div className="h-[180px] w-full animate-pulse bg-white/60" />
    );
  }
