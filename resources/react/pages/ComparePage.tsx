    ...
    <div dir={dir} className="min-h-screen overflow-x-hidden bg-[#f3f6fa]">
      <div className="relative z-20 mt-[80px] px-6 pb-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-[minmax(320px,464px)_1fr_minmax(320px,464px)] items-start gap-12 max-lg:grid-cols-1 max-lg:max-w-[464px] max-lg:mx-auto max-lg:gap-7">
            {/* Car 1 slot */}
